...
| Membres | `GET/POST /api/membres`, `POST /api/membres/import` (vCard, CSV, export WhatsApp ; `dry_run` pour l'aperçu), `GET/PATCH/DELETE /api/membres/{id}`, `/notes`, `/consentement`, `/desinscription`, `/export`, `/message` |
